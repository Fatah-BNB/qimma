    ...
    return (
        <div>
            ...
            <div className="bg-gray-50 px-20 pb-10 text-right">
                <p class="p-8 text-center mx-auto font-bold text-primary text-4xl">Qimma <span className="text-secondary">|</span> قمة</p>
                        ...
                        <div className="space-y-12 x">
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <fieldset>
                                    ...
                                    <div className="mt-10 flex flex-row-reverse justify-around space-x-10 ">
